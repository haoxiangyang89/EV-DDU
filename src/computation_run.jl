...
xhat, uhat, UBList, LBList, timeList = colGen(probData, f, c, xbar, x0, u0, ρ, Delta, 1e-4, "bilinear", "piecewise", 1);
xhat, uhat, UBList, LBList, timeList = colGen(probData, f, c, xbar, x0, u0, ρ, Delta, 1e-4, "bilinear", "piecewise");
save("./result/$(caseList[ci])_linear_piecewise.jld2", "xhat", xhat, "uhat", uhat, "UBList", UBList, "LBList", LBList, "timeList", timeList);
