# test higher ρ's impact on expansion
using Plots;
...
LBList_Dict = Dict();
timeList_Dict = Dict();
for ρ in [50, 70, 90, 110, 130, 150]
    xhat_Dict[ρ], uhat_Dict[ρ], UBList_Dict[ρ], LBList_Dict[ρ], timeList_Dict[ρ] = colGen(probData, f, c, xbar, x0, u0, ρ, Delta, 1e-4, "linear", "piecewise");
    save("./result/$(caseList[ci])_Delta_result.jld", "xhat_Dict", xhat_Dict, "uhat_Dict", uhat_Dict,
        "UBList_Dict", UBList_Dict, "LBList_Dict", LBList_Dict, "timeList_Dict", timeList_Dict);
end